      ...
      <div className="auth-illustration-graphic">
        ...
        >
          ...
          <g opacity="0.85">
            ...
            <circle cx="200" cy="80" r="8" fill="#4f46e5" stroke="#ffffff" strokeWidth="2" />
            <circle cx="80" cy="180" r="6" fill="#818cf8" stroke="#ffffff" strokeWidth="1.5" />
            <circle cx="320" cy="180" r="6" fill="#818cf8" stroke="#ffffff" strokeWidth="1.5" />
            <circle cx="200" cy="220" r="8" fill="#4f46e5" stroke="#ffffff" strokeWidth="2" />
          </g>

          {/* Secure Shield tag */}
          <g transform="translate(180, 125)" opacity="0.95">
            <rect x="0" y="0" width="40" height="46" rx="6" fill="rgba(15, 23, 42, 0.85)" stroke="var(--color-primary)" strokeWidth="2" />
            <path
